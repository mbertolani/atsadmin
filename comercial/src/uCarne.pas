...
type
  TfCarne = class(TForm)
    ...
    buscaCliTEM_IE: TStringField;
    buscaCliDATARESC: TDateField;
    buscaCliNOMEMAE: TStringField;
    ...
    buscaCliEMVIAGEM: TStringField;
    buscaCliDTAALTERA: TDateField;
    buscaCliSERIELETRA: TStringField;
    buscaCliSERIE: TStringField;
    buscaCliRA: TStringField;
    buscaCliCURSO: TStringField;
    buscaCliIP: TStringField;
    buscaCliN_CONTRATO: TStringField;
    buscaCliMAC: TStringField;
    buscaCliMARCA: TStringField;
    buscaCliBANDA_UPLOAD: TStringField;
    buscaCliBANDA_DOWLOAD: TStringField;
    buscaCliTORRE_CONECCAO: TStringField;
    buscaCliCOD_FAIXA: TIntegerField;
    buscaCliDESCONTO: TFloatField;
    buscaCliMENSALIDADE: TFloatField;
    buscaCliANUIDADE: TFloatField;
    buscaCliPARCELA: TIntegerField;
    buscaCliPARCELAGERADAS: TIntegerField;
    buscaCliNUMERO: TIntegerField;
    buscaCliDATANASCIMENTO: TSQLTimeStampField;
    buscaCliANOLETIVO: TStringField;
    buscaCliSITUACAOESCOLAR: TStringField;
    buscaCliRGMAE: TStringField;
    buscaCliCPFMAE: TStringField;
    buscaCliPAI: TStringField;
    buscaCliRGPAI: TStringField;
    buscaCliCPFPAI: TStringField;
    buscaCliLANCADOCLASSE: TIntegerField;
    buscaCliTRANSPORTE: TStringField;
    buscaCliCIDADENASC: TStringField;
    buscaCliUFNASC: TStringField;
    buscaCliNACIONALIDADE: TStringField;
    buscaCliCERTIDAONASCNUM: TStringField;
    buscaCliLIVRONASC: TStringField;
    buscaCliFLLIVRONASC: TStringField;
    buscaCliLOCALTRABPAI: TStringField;
    buscaCliLOCALTRABMAE: TStringField;
    buscaCliTELTRABPAI: TStringField;
    buscaCliTELTRABMAE: TStringField;
    buscaCliINFONECESSARIAS: TStringField;
    buscaCliCARTEIRAVACINACAO: TStringField;
    buscaCliRAPRODESP: TStringField;
    buscaCliLOCALTRABALUNO: TStringField;
    buscaCliTELTRABALUNO: TStringField;
    buscaCliRAPROD: TStringField;
    buscaCliCERT_NAS_COMARCA: TStringField;
    buscaCliCERT_NAS_UF: TStringField;
    buscaCliCERT_NAS_MUNICIPIO: TStringField;
    buscaCliCERT_NAS_DISTRITO: TStringField;
    buscaCliCERT_NAS_SUBDISTRITO: TStringField;
    buscaCliDIVERSO1: TStringField;
    buscaCliDIVERSO2: TStringField;
    buscaCliDATAEMISSAORG: TDateField;
    buscaCliESTADORG: TStringField;
    buscaCliCOMUNICAALUNO: TStringField;
    buscaCliFONEMAE: TStringField;
    buscaCliCELULARMAE: TStringField;
    buscaCliCOMUNICAMAE: TStringField;
    buscaCliFONEPAI: TStringField;
    buscaCliCELULARPAI: TStringField;
    buscaCliCOMUNICAPAI: TStringField;
    buscaCliVALOR_MATRICULA: TFloatField;
    buscaCliDATATRANSF: TDateField;
    buscaCliCOR_RACA: TStringField;
    buscaCliPERIODO: TStringField;
    buscaCliFOTO: TStringField;
    buscaCliDATA_MATRICULA: TSQLTimeStampField;
    buscaCliCODRESPONSAVEL: TIntegerField;
    buscaCliID_COB: TIntegerField;
    buscaCliCOD_TRANPORTADORA: TIntegerField;
    buscaCliBLOQUEADO: TStringField;
...
begin
     ...
     begin
        ...
        parcela                         := StrToInt(scdsCr_procVIA.AsString);
