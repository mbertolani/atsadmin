...
uses UDm, uProcurar, uClienteCadastro, ufDlgLogin, sCtrlResize, Utils;
...
begin
  varCondicao:= '';
   ...
   'left outer join ACADEMIATURMAALUNO at on at.CODALUNO = cli.CODCLIENTE';
...
//********************************************************************************************
 ...
 begin
  ...
  begin
    if varCondicao <> '' then
      varCondicao := varCondicao + ' and at.CODTURMA = ' + IntToStr(cdsModalidadeCODTURMA.asInteger)
    else
      varCondicao := 'where at.CODTURMA = ' + IntToStr(cdsModalidadeCODTURMA.asInteger);
  end;
 end;
 //********************************************************************************************
 ...
 begin
   ...
   begin
     if varCondicao <> '' then
       ...
       varCondicao := 'where ';
     varCondicao := varCondicao + ' UDF_AGE2(cli.DATANASC) between ' + idadeIni.Text +
         ' and ' + idadeFim;
   end;
   ...
   begin
     ...
     if varCondicao <> '' then
       ...
       varCondicao := 'where ';
     varCondicao := varCondicao + ' cli.DATANASC between ' +
       QuotedStr(formatDateTime('mm/dd/yyyy', t.pegaIni) +
         ' and ' + QuotedStr(formatDateTime('mm/dd/yyyy', t.pegaIni);
   end;
 end;
//********************************************************************************************
...
procedure TfListaClientes.cbFormaNascimentoChange(Sender: TObject);
begin
  if (cbFormaNascimento.Text = 'Idade') then
  begin
