CREATE TRIGGER INSERE_TRANSP_FORNEC FOR TRANSPORTADORA
...
BEGIN 
  ...
  begin
    ...
    new.CEP, UDF_COPY(new.FONE , 2,2) , UDF_LEFT(new.FONE , 9), UDF_LEFT(new.FONE2 , 9), NULL, 
    UDF_LEFT(new.FAX , 9), NULL, NULL, 0, NULL, null, NULL);
  end 
END
