inherited fAlunoCadastro: TfAlunoCadastro
  Left = 199
  Top = 124
  Width = 780
  Height = 580
      ...
      object JvDBUltimGrid4: TJvDBUltimGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Hor'#225'rio Entrada'
            Width = 100
            Visible = True
          end
          item
  ...
  object sqlFreq: TSQLDataSet
    CommandText = 
      'select a.DATAFREQUENCIA, atu.NOMETURMA, a.HORARIOENTRADA from AC' +
      'ADEMIAFREQUENCIA a '#13#10'inner join ACADEMIATURMA atu on atu.CODTURM' +
      'A = a.CODTURMA'#13#10'where a.CODCLIENTE = :pCliente and a.PRESENTE = ' +
      #39'P'#39#13#10'order by a.DATAFREQUENCIA desc '
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object cdsFreq: TClientDataSet
    ...
    Left = 116
    Top = 246
    object cdsFreqDATAFREQUENCIA: TDateField
      FieldName = 'DATAFREQUENCIA'
    end
    object cdsFreqNOMETURMA: TStringField
      FieldName = 'NOMETURMA'
      Size = 80
    end
    object cdsFreqHORARIOENTRADA: TTimeField
      FieldName = 'HORARIOENTRADA'
    end
  end
