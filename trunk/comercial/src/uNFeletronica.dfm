object fNFeletronica: TfNFeletronica
  ...
  object sdsItensNF: TSQLDataSet
    CommandText = 
      ...
      '   md.ICMS,'#13#10'          md.pIPI,'#13#10'          md.vIPI,          md.' +
      ...
      'md.ICMS_SUBSTD,'#13#10'          UDF_ROUNDDEC((md.VLR_BASE * md.QUANTI' +
      'DADE), 2) as VALTOTAL'#13#10'from VENDA vd '#13#10'inner join MOVIMENTODETAL' +
      'HE md on'#13#10'md.CODMOVIMENTO = vd.CODMOVIMENTO '#13#10'inner join NOTAFIS' +
      'CAL nf on'#13#10'nf.CODVENDA = vd.CODVENDA'#13#10'inner join PRODUTOS pr on ' +
