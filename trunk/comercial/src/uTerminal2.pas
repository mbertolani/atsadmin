    ...
    begin
      try
        ...
        begin
          ...
          MessageDlg('Exclua a finalizaÁ„o primeiro.', mtWarning, [mbOK], 0);
          exit;
        end;
...
begin
  ...
  begin
   ...
   // else
    ...
    if comando = 0 then
    begin
      MessageDlg('Problemas na impress√£o do texto.' + #10 + 'Possiveis causas: Impressora desligada, off-line ou sem papel', mtError, [mbOk], 0 );
      exit;
    end;
