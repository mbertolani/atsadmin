...
type
  TDM = class(TDataModule)
    ...
    sds_EmpresaCODINDCRITESCRIT: TStringField;
    sds_EmpresaINDCODINCIDENCIA: TStringField;
    sds_EmpresaINDCTA: TStringField;
    sds_EmpresaINDESCRITURACAO: TStringField;
    sds_EmpresaBASECALCULOCREDITO: TStringField;
    sds_EmpresaINDAJ: TStringField;
    sds_EmpresaCODAJ: TStringField;
    sds_EmpresaINDNATREC: TStringField;
    sds_EmpresaNATCREDDESC: TStringField;
    sds_EmpresaCODCRED: TStringField;
    sds_EmpresaINDTIPCOOP: TStringField;
    sds_EmpresaINDCREDORI: TStringField;
    sds_EmpresaINDREC: TStringField;
    sds_EmpresaINDDESCCRED: TStringField;
    sds_EmpresaCODCONT: TStringField;
    sds_EmpresaINDNATRETFONTE: TStringField;
    sds_EmpresaINDORIGEMDIVERSAS: TStringField;
    sds_EmpresaINDNATDEDUCAO: TStringField;
    sds_EmpresaINDTPOPERACAORECEITA: TStringField;
    ...
    cds_empresaCODINDCRITESCRIT: TStringField;
    cds_empresaINDCODINCIDENCIA: TStringField;
    cds_empresaINDCTA: TStringField;
    cds_empresaINDESCRITURACAO: TStringField;
    cds_empresaBASECALCULOCREDITO: TStringField;
    cds_empresaINDAJ: TStringField;
    cds_empresaCODAJ: TStringField;
    cds_empresaINDNATREC: TStringField;
    cds_empresaNATCREDDESC: TStringField;
    cds_empresaCODCRED: TStringField;
    cds_empresaINDTIPCOOP: TStringField;
    cds_empresaINDCREDORI: TStringField;
    cds_empresaINDREC: TStringField;
    cds_empresaINDDESCCRED: TStringField;
    cds_empresaCODCONT: TStringField;
    cds_empresaINDNATRETFONTE: TStringField;
