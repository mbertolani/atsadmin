object fNFPaulista: TfNFPaulista
  ...
  object sdsNF: TSQLDataSet
    CommandText = 
      'select  '#13#10'           nf.CFOP,           nf.DTAEMISSAO,          ' +
      '  nf.DTASAIDA,                               nf.CORPONF1,       ' +
      '     nf.CORPONF2,           nf.CODCLIENTE,                    nf' +
      '.NUMNF,           nf.CODVENDA,           nf.BASE_ICMS,          ' +
      '            nf.VALOR_ICMS,           nf.BASE_ICMS_SUBST,'#13#10'      ' +
      '     nf.VALOR_ICMS_SUBST,           nf.VALOR_PRODUTO,'#13#10'         ' +
      '  nf.VALOR_FRETE,           nf.VALOR_SEGURO,                    ' +
      '  nf.OUTRAS_DESP,           nf.VALOR_IPI,                      n' +
      'f.VALOR_TOTAL_NOTA,           nf.FRETE,           nf.CNPJ_CPF,  ' +
      '          '#13#10'           cast(nf.NOMETRANSP as varchar (60) )as NO' +
      'METRANSP,'#13#10'           nf.INSCRICAOESTADUAL,                     ' +
      ' '#13#10'           cast(nf.END_TRANSP as varchar (60) )as END_TRANSP,' +
      #13#10'           cast(nf.CIDADE_TRANSP as varchar (60) )as CIDADE_TR' +
      'ANSP,                                  nf.UF_TRANSP,            ' +
      'nf.PLACATRANSP,            nf.UF_VEICULO_TRANSP,            nf.Q' +
      'UANTIDADE,            nf.ESPECIE,              nf.MARCA,        ' +
      '   nf.NUMERO,           nf.PESOLIQUIDO,                         ' +
      '    nf.PESOBRUTO,           cl.RAZAOSOCIAL,          cl.CNPJ , n' +
      'f.HORASAIDA, nf.NOTASERIE'#13#10'from NOTAFISCAL nf '#13#10'inner join CLIEN' +
      'TES cl on cl.CODCLIENTE = nf.CODCLIENTE'#13#10'inner join enderecoclie' +
      'nte endecli on endecli.CODCLIENTE = cl.CODCLIENTE'#13#10'where DTAEMIS' +
      'SAO between :dta1 and :dta2  and (nf.SERIE = :pvendacusto)'#13#10'and ' +
      'endecli.UF = '#39'SP'#39' and endecli.TIPOEND = 0'#13#10'order by NOTASERIE'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
