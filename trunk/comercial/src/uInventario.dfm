inherited fInventario: TfInventario
  ...
  object btnIncluiTodos: TButton [7]
    Left = 80
    Top = 208
    Width = 25
    Height = 33
  ...
  object btnInclui: TButton [8]
    Left = 144
    Top = 208
    Width = 25
    Height = 33
    Hint = 'Item Selecionado'
    Caption = '-->'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clNavy
    Font.Height = -11
  ...
  object btnRemoveTodos: TButton [9]
    Left = 112
    Top = 208
    Width = 25
    Height = 33
  ...
  object sdsProd: TSQLDataSet
    CommandText = 'SELECT CODPRO, CODPRODUTO, PRODUTO, UNIDADEMEDIDA FROM PRODUTOS'
    MaxBlobSize = -1
    Params = <>
