...
begin
  ...
  begin
    ...
    str := str + ', CSTIPI = ' + FloatToStr(cds_estadoCSTIPI.AsFloat);
    ...
    str := str + ', CSTPIS = ' + FloatToStr(cds_estadoCSTPIS.AsFloat);
    str := str + ', PIS = ' + FloatToStr(cds_estadoPIS.AsFloat);
    str := str + ', CSTCOFINS = ' + FloatToStr(cds_estadoCSTCOFINS.AsFloat);
