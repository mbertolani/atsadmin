...
//      executaScript('calcula_icms_substprod.sql');
    ...
    begin
      ...
      executaDDL('SPEDPISCOFINS', UpperCase('CodFinalidade'),        'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndicadorMovimento'),   'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('Perfil'),               'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('Atividade'),            'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('VersaoLeiaute'),        'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodFinalidade'),        'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('TipoEscrituracao'),    'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndicadorNaturezaPJ'), 'SMALLINT'); // Indicador da natureza da pessoa juridica
      executaDDL('SPEDPISCOFINS', UpperCase('IndicadorAtividade'),  'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodIndIncTributaria'), 'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndAproCred'),         'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodIndTipoCon'),       'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodIndCritEscrit'),    'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndCodIncidencia'),    'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndCTA'),              'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndEscrituracao'),     'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('BaseCalculoCredito'),  'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndAJ'),               'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodAj'),               'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndNatRec'),           'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('NatCredDesc'),         'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodCred'),             'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndTipCoop'),          'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndCredOri'),          'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndRec'),              'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndDescCred'),         'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('CodCont'),             'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndNatRetFonte'),      'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndOrigemDiversas'),   'SMALLINT');
      executaDDL('SPEDPISCOFINS', UpperCase('IndNatDeducao'),       'VARCHAR(50)');
      executaDDL('SPEDPISCOFINS', UpperCase('IndTpOperacaoReceita'),'SMALLINT');
