...
BEGIN 
  ...
  begin  
    ...
    FOR SELECT DATACONSOLIDA, ORDEM, DESCRICAO, sum(VALORC), sum(VALORD), CAIXA, FORMA, N_DOC, COMPENSADO
      FROM sp_mov_caixaSintetico(:DTAINI, :DTAFIM, :COD_CAIXA) 
      group by DATACONSOLIDA, ORDEM, N_DOC, DESCRICAO, CAIXA, FORMA, COMPENSADO
    INTO :DATACONSOLIDA, :ORDEM, :DESCRICAO, :VALORC, :VALORD, :CAIXA
