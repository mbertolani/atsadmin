SET TERM ^ ;
ALTER TRIGGER MOV_ESTOQUE ACTIVE
...
BEGIN 
  ...
  /* no momento da Venda ou Compra                                                   */ 
    ...
    if (atualizaEstoque = 'S') then 
    begin 
        --if (InsereEdita = 'I') then 
        --begin 
            preco = new.PRECO;
            qtde  = new.QUANTIDADE;
        --end 
        /*
        if (InsereEdita = 'E') then 
        begin 
            preco = new.PRECO - old.PRECO;
    ...
    */
        ...
        -- se houver um lançamento com data maior ou igual a este , então tem que executar o corrige ESTOQUE
        tem_Mov = 'N';
