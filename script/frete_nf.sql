...
--alter table MOVIMENTODETALHE add VALOR_DESCONTO double precision
   ...
   do begin
	...
	begin
	 ...
	 if ( det = det1) then
	   update MOVIMENTODETALHE set FRETE = :Frete_TOTAL, valor_desconto = :DESCONTO_TOTAL, valor_seguro = :SEGURO_TOTAL, valor_outros = :OUTRAS_TOTAL where CODDETALHE = :coddet;
    end
	else
